...
\begin{block_mdfboxadmon}[Linear algebra and eigenvalue problems chapters 6 and 7.]
\begin{itemize}
...
\begin{block_mdfboxadmon}[Numerical integration standard methods and Monte Carlo methods (chapters 4 and 11).]
\begin{itemize}
...
\begin{block_mdfboxadmon}[Monte Carlo methods in physics (chapters 12 13 and 14).]
\begin{itemize}
...
\begin{block_mdfboxadmon}[Ordinary differential equations (chapters 8 and 9).]
\begin{itemize}
...
\begin{block_mdfboxadmon}[Partial differential equations chapter 10.]
\begin{itemize}
...
\begin{block_mdfboxadmon}[Bachelor/Master/PhD Courses.]
\begin{itemize}
...
\begin{block_mdfboxadmon}[and discussed at the lab sessions the first week.]
\begin{itemize}
