...
\begin{block}{and discussed at the lab sessions the first two weeks (see guides at the \href{{http://www.uio.no/studier/emner/matnat/fys/FYS3150/h15/index.html}}{website of the course}) }
\begin{itemize}
...
\begin{frame}[plain,fragile]
\frametitle{Hello World, dissecting the code}
...
\begin{frame}[plain,fragile]
\frametitle{Hello World, more dissection}
...
\begin{frame}[plain,fragile]
\frametitle{From decimal to binary representation, the actual operation}
...
\begin{minted}[fontsize=\fontsize{9pt}{9pt},linenos=false,mathescape,baselinestretch=1.0,fontfamily=tt,xleftmargin=2mm]{fortran}
...
\begin{frame}[plain,fragile]
\frametitle{Loss of Precision, example}
...
\begin{frame}[plain,fragile]
\frametitle{Loss of Precision, consequences}
...
\begin{frame}[plain,fragile]
\frametitle{Call by value or reference}
...
\begin{frame}[plain,fragile]
\frametitle{Unit Testing, benefits}
